          ...
          <div class="container">
            <div class="row">
              <div class="col-9 social">
                ...
                <a href="{{ route('home') }}"><span class="fa fa-youtube-play"></span></a>
              </div>
        ...
        <div class="container logo-wrap">
          <div class="row pt-5">
            <div class="col-12 text-center">
              ...
              <h1 class="site-logo"><a href="index.html">Dashmantul</a></h1>
            </div>
          </div>
        </div>
                ...
                <div class="col-md-6">
                  <a href="blog-single.html" class="blog-entry element-animate" data-animate-effect="fadeIn">
                    ...
                    <div class="blog-content-body">
                      <div class="post-meta">
                        <span class="author mr-2"><img src="images/person_1.jpg" alt="Colorlib"> Colorlib</span>&bullet;
                        <span class="mr-2">{{$datas->created_at}}</span> &bullet;
                        <span class="ml-2"><span class="fa fa-comments"></span> 3</span>
                      </div>
                      <h2>{{$datas->title}}</h2>
                    </div>
